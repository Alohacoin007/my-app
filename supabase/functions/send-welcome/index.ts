...
<tr><td class="pad" style="padding:24px 30px 2px;text-align:center;"><span style="display:inline-block;background:#eaf0ff;border-radius:999px;padding:6px 13px;font-size:10.5px;font-weight:800;letter-spacing:.8px;text-transform:uppercase;color:#2742C9;">&#127873; Welcome bonus credited</span><div style="font-size:54px;font-weight:800;letter-spacing:-2.5px;color:#11141a;margin-top:16px;line-height:1;">$100<span style="font-size:18px;font-weight:700;color:#aab0bd;margin-left:6px;letter-spacing:0;">USDT</span></div><div style="font-size:13px;color:#7a828f;margin-top:12px;line-height:1.5;">In your Sports wallet. Your first bet's on us.</div></td></tr>
