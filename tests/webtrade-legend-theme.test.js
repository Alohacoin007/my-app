...
// Market Watch = MT5 light (2026-08-13): up=파랑 #1a1acd, down=빨강 #d51111
...
if (!/\.terminal\.light \.mwtp \.sd\.buy \.pr\{color:#1a1acd\}/.test(src)) bad('Trading BUY price must be blue (MT5, #1a1acd)');
