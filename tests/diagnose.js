...
const CHECKS = [
  ...
  { id: 'PRICE-fake-sway', sev: 'HIGH', files: ['crypto-live.html', 'trading.html'],
    re: /swayPct\s*\*\s*base/i,
    why: 'Displayed price fabricated by adding a sine "sway" to the real base — drifts up to ±% off the exchange (Binance $63k → app $62k), a fake price on a trading screen. Mark to the live feed only (2026-07-07).' },
