...
const CHECKS = [
  ...
  { id: 'FX-client-settlement-insert', sev: 'CRITICAL', files: ['trading.html', 'webtrade.html', 'dev/fx-terminal.html'],
  ...
  { id: 'FX-client-position-statuswrite', sev: 'CRITICAL', files: ['trading.html', 'webtrade.html', 'dev/fx-terminal.html'],
  ...
  { id: 'PEND-client-table-write', sev: 'CRITICAL', files: DEPLOYED.concat(['dev/fx-terminal.html', 'dev/crypto-dashboard.html']),
